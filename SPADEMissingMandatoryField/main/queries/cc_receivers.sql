...
select distinct case when manager = alias then sr_manager
                     else team.manager end                        as manager
                , case when manager = alias then concat(team.sr_manager,'@amazon.com')
                       else concat(team.manager,'@amazon.com') end       as manager_email
from (select issueid,
             title,
             issueurl,
             assignedfolderid,
